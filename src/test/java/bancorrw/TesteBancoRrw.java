...
public class TesteBancoRrw{
    ...
    public void setUp() throws Exception {
        // Inicializa os DAOs aqui, garantindo que não sejam nulos.
        ...
        // Excluir os dados na ordem correta para evitar erros de chave estrangeira
        invDao.deleteAll();
        corDao.deleteAll();
        cliDao.deleteAll();
    }
    ...
    public void t27crudContaCorrenteAdd() throws Exception {
        ...
        assertEquals("Quando inserir a conta corrente no BD, recupere o ID gerado e sete no objeto da conta.",1, conta.getId());
    }
    ...
    public void t28crudContaCorrenteGetById() throws Exception {
        ...
        assertEquals(1, conta2.getCliente().getContaCorrente().getId());
    ...
    public void t31crudContaInvestimentoAdd() throws Exception {
        ...
        assertEquals("No momento da dao adicionar a conta investimento no BD obtenha o número gerado pelo BD do ID e sete o id do objeto.",1, conta1.getId());
        assertEquals("No momento da dao adicionar a conta investimento no BD obtenha o número gerado pelo BD do ID e sete o id do objeto.",2, conta2.getId());
    ...
    public void t32crudContaInvestimentoGetById() throws Exception {
        ...
        assertEquals(1, conta1BD.getCliente().getContasInvestimento().get(0).getId());
        ...
        assertEquals(2, conta2BD.getCliente().getContasInvestimento().get(0).getId());
